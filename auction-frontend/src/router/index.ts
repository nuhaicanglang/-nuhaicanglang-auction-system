...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'orders', name: 'admin-orders', component: () => import('@/views/admin/AdminOrdersView.vue'), meta: { title: '订单总表', requiresAuth: true, roles: ['ADMIN', 'SUPER_ADMIN'], menu: true } },
      { path: 'logs', name: 'admin-logs', component: () => import('@/views/admin/OperLogView.vue'), meta: { title: '操作日志', requiresAuth: true, roles: ['ADMIN', 'SUPER_ADMIN'], menu: true } },
    ],
  },
